...
echo "<br><br>";
echo "Estaba ya visto?: " .  isVideoCompleted ($course_id,$sco_id,$id_video);
echo "<br><br>";
echo "Guardado: " . $client->saveLecturesScos($course_id,$sco_id,$id_video);
// echo isVideoCompleted ($course_id,1,67);
echo "<br><br>";
echo "El indice del video guardado es el: " . GetKeyFromPagesArray ($pages_array,$id_video);
echo "<br><br>";
